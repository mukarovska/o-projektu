        ...
        <div className="grace">
          ...
          <div className="aboutTeam--textContent">
            ...
            <p className="aboutTeam--text">
              ...
              stretávam sa s priateľmi. Jsem taký extrovertný introvert.
            </p>
          </div>
        </div>
        ...
        <div className="kaja">
          <div className="aboutTeam--textContent">
            ...
            <p className="aboutTeam--text">
              ...
              Pracovala jsem jako grafik/fotograf a asistent účetní Ráda se učím
              novým věcem, ať už se jedná právě o IT nebo například rukodělné
              činnosti. Věnuji se lezení na umělých stěnách, jsem členkou
              skautského střediska a radost mi dělá pobyt v přírodě. Jsem
              optimista, který se vždy snaží rozdávat dobrou náladu.
            </p>
          </div>
